...
#include <array> // WICHTIG: Für std::array
...
namespace JanSordid::HSNR64
{
    ...
    // =========================================================
    // HIER IST DEINE MAP DEFINITION
    // =========================================================
    // Wir definieren den MapType global für dein Spiel.
    // Breite: 160, Höhe: 20
    using MapType = std::array<std::array<int, 160>, 20>;
}